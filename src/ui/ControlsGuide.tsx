  ...
  return (
    <div className="controls-guide">
      ...
      <p className="transition-copy">
        Tap Q again during the suit animation to reverse it. Gameplay abilities stay on the current
        committed state until the animation reaches fully suited or fully bare.
      </p>
